...
<?php while (have_posts()) : the_post(); ?>
  ...
  <section class="header-bottom header-bottom--simple header-bottom--big">
    <p class="text-white text-tag"><?php _e('no palácio', 'chiado'); ?></p>
    <div class="header-bottom__title"><?php the_field('intro_text'); ?></div>
